        ...
        <div className="team-pictures">
          {[
            ...
            },
            {
              ...
              image: require("../../images/team/MarianQian.png").default,
            },
            {
              name: "Forrest Meng",
              about:
              ...
              image: require("../../images/team/ForrestMeng.png").default,
            },
            {
              name: "Tammy Ding",
              about:
              ...
              image: require("../../images/team/TammyDing.png").default,
            },
            {
              name: "Jazon He",
              about:
              ...
              image: require("../../images/team/JazonHe.png").default,
            },
            {
              ...
              image: require("../../images/team/RashadPhilizaire.png").default,
            },
            {
              name: "Raunak Daga",
              about:
              ...
              image: require("../../images/team/RaunakDaga.png").default,
            },
            {
              ...
              image: require("../../images/team/SadhikaDhanasekar.png").default,
            },
            {
              name: "Sumanth Ratna",
              about:
              ...
              image: require("../../images/team/SumanthRatna.png").default,
            },
            {
              name: "Anika Karpurapu",
              about:
                "Anika is a junior at TJ and works on internet/tech, judging, and designing HackTJ branding and merch. She decided to join the HackTJ Team and be part of the organization process after having an amazing time during her freshman year hackathon. To pursue her interests, Anika participates in CyberPatriot, where she teaches various cybersecurity concepts, Women in Science and Engineering (WISE).default, through which she promotes girls’ journeys in STEM, and competes as part of TJ’s computer teams. In her free time, she can be found running, baking, or hanging out with friends and family.",
              image: require("../../images/team/AnikaKarpurapu.png").default,
            },
            {
              ...
              image: require("../../images/team/ArjunJagannathan.png").default,
            },
            {
              name: "Pranav Mathur",
              about:
              ...
              image: require("../../images/team/PranavMathur.png").default,
            },
            {
              name: "Samhita Vinay",
              about:
              ...
              image: require("../../images/team/SamhitaVinay.png").default,
            },
            {
              name: "Shreya Singh",
              about:
              ...
              image: require("../../images/team/ShreyaSingh.png").default,
            },
            {
              name: "Shreyas Mayya",
              about:
              ...
              image: require("../../images/team/ShreyasMayya.png").default,
            },
            {
              name: "Ms. Razzino",
              about:
              ...
              image: require("../../images/team/MsRazzino.jpg").default,
            },
          ].map((person) => (
            <TeamPicture
              name={person.name}
